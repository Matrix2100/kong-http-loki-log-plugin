...
for _, strategy in helpers.each_strategy() do
  describe("Plugin: http-loki-log (log) [#" .. strategy .. "]", function()
    local proxy_client
  ...
  --   describe("Plugin: http-loki-log (log) queue (worker_processes = " .. workers .. ") [#" .. strategy .. "]", function()
  --     local proxy_client
  ...
  -- describe("Plugin: http-loki-log (log) enabled globally [#" .. strategy .. "]", function()
  --   local proxy_client
  ...
  --     -- a route when no such value exists after http-loki-log execution
